...
print(f"the number of loans available are {number_of_loans}")
...
print(f"the future value and remaining months are: ${future_value}, and {remaining_months} months ")
...
print(f"the remaining months on this loan is {remaining_months} months")
